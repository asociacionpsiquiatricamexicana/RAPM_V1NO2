...
| 12 | `\APMtype{}` está conectado al render del header | `grep '@apmtype' apm-editorial.cls` — debe aparecer tanto en el setter como en el macro que construye el header. **Ver `09_limitaciones_conocidas.md` #1: hoy NO está conectado.** |
