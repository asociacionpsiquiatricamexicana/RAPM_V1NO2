% ═══════════════════════════════════════════════════════════════
% Neuromodulation Editorial — Content File
% Uses: apm-editorial.cls (must be in same directory)
% Compile: pdflatex editorial-neuromod.tex (×2)
% ═══════════════════════════════════════════════════════════════
...
%                    Ver references/09_limitaciones_conocidas.md. No lo uses.
\APMvolume{5}{2}{2025}
\APMperiod{MAYO--AGOSTO}
\APMlogo{logo_hires.png}
\APMlogoSixty{logo_60anos.png}
...
% ── REFERENCES ───────────────────────────────────────────────
% Split after ref 5 for optimal column balance on page 2.
% Use \APMrefsbreak where the column should break.
...
\APMrefsbreak  % ← column break here for balanced page 2
