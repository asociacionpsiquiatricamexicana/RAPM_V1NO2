...
Se corrigió únicamente la prosa de autor. Quedaron intactos, conforme a la capa cero del pipeline correctivo,
los **368 asientos bibliográficos**, los **155 epígrafes**, las **45 citas de entrevista** y la atribución de epígrafe:
en total, 569 bloques verificados sin una sola alteración. El índice, las anclas de navegación y la paginación
(268 páginas antes y después) permanecen idénticos.

**81 correcciones** en 47 bloques.

## Erratas y concordancia (3)

- **[244]** concordancia: «El silencio… llamativa» → «llamativo»
- **[280]** «la propio gremio» → «del propio gremio»
- **[1673]** «la propio gremio» → «del propio gremio»

## Sintaxis (3)

- **[379]** coordinación defectuosa «julio y 4 de agosto» → «sesiones de julio y del 4 de agosto»
- **[789]** ídem
- **[809]** ídem

## Léxico proscrito (2)

- **[231]** «en el campo de» (locución proscrita) → «en materia de»
- **[464]** «en el terreno de este… por este» → «en sus propios espacios… por él»

## Coherencia terminológica interna (5)

- **[865]** «11 de septiembre» → «once de septiembre» (forma usada en el resto del volumen)
- **[1113]** «Estados Unidos» → «los Estados Unidos»
- **[1116]** «Estados Unidos» → «los Estados Unidos»
- **[1432]** «voto secreto y directo» → «voto cerrado y directo» (término fijado en los caps. II-III)
- **[1653]** «voto secreto y directo» → «voto cerrado y directo» (término fijado en los caps. II-III)

## Cifras y separador decimal (8)

- **[471]** punto decimal → coma decimal: 28.6, 13.9, 5.8, 12.1
- **[473]** punto decimal → coma decimal: 3.47, 20.3, 3.68
- **[474]** punto decimal → coma decimal: 60.34, 20.73
- **[490]** punto decimal → coma decimal: 1.6, 3.47
- **[975]** punto decimal → coma decimal: 60.34
- **[1895]** decimal deletreado «punto» → «coma»
- **[1897]** decimal deletreado «punto» → «coma»
- **[1898]** decimal deletreado «punto» → «coma»

## Cursiva (títulos de obra y latinismos) (36)

- **[133]** «Psicología médica» → cursiva (título de obra mayor)
- **[193]** «Psicología médica» → cursiva
- **[205]** «Esa agonía llamada locura. Historia de la psiquiatría» → cursiva
- **[205]** «Las enfermedades mentales en México. Desde los mexicas hasta el final del milenio» → cursiva
- **[205]** «Salud mental comunitaria. Un nuevo enfoque de la psiquiatría» → cursiva
- **[471]** «Manual diagnóstico y estadístico de los trastornos mentales» → cursiva
- **[654]** «Burnout. En la línea de fuego» → cursiva (título de obra mayor)
- **[1135]** «Extension for Community Healthcare Outcomes» → cursiva
- **[1375]** «Extension for Community Healthcare Outcomes» → cursiva
- **[1375]** «Manual diagnóstico y estadístico de los trastornos mentales» → cursiva
- **[1475]** «Testimonios» → cursiva
- **[1519]** «honoris causa» → cursiva
- **[1520]** «honoris causa» → cursiva
- **[1521]** segunda aparición de «honoris causa» → cursiva
- **[1521]** «honoris causa» → cursiva
- **[1546]** «in memoriam» → cursiva
- **[1654]** «Voces de la psiquiatría. Los precursores» → cursiva (título de obra mayor)
- **[1655]** «Historia de la psiquiatría en México» → cursiva (título de obra mayor)
- **[1662]** «In memoriam» → cursiva
- **[1666]** «American Journal of Psychiatry» → cursiva
- **[1666]** «The Journal of Nervous and Mental Disease» → cursiva
- **[1673]** «Gaceta de la Facultad de Medicina» → cursiva
- **[1673]** «Salud Mental» → cursiva
- **[1677]** «Salud Mental» → cursiva
- **[1679]** «Luvina» → cursiva
- **[1680]** «Revista Internacional de Investigación en Adicciones» → cursiva
- **[1680]** «Salud Mental» → cursiva
- **[1682]** «Salud Mental» → cursiva
- **[1685]** «Mente y Cultura» → cursiva
- **[1685]** «Mente y Cultura» → cursiva
- **[1685]** «Salud Mental» → cursiva
- **[1685]** «Salud Mental» → cursiva
- **[1687]** «Voces de la psiquiatría. Los precursores» → cursiva (título de obra mayor)
- **[1837]** «in memoriam» → cursiva
- **[1931]** colofón: título de la obra en cursiva
- **[1931]** la capitular del colofón se mantiene en redonda

## Espaciado y saltos de línea (22)

- **[1]** 1 espacio(s) espurio(s) tras salto de línea
- **[36]** 3 espacio(s) espurio(s) tras salto de línea
- **[38]** 1 espacio(s) espurio(s) tras salto de línea
- **[110]** 1 espacio(s) espurio(s) tras salto de línea
- **[125]** 1 espacio(s) espurio(s) tras salto de línea
- **[268]** 2 espacio(s) espurio(s) tras salto de línea
- **[446]** 1 espacio(s) espurio(s) tras salto de línea
- **[645]** 1 espacio(s) espurio(s) tras salto de línea
- **[979]** 1 espacio(s) espurio(s) tras salto de línea
- **[1263]** sub: doble espacio → simple
- **[1268]** 1 espacio(s) espurio(s) tras salto de línea
- **[1298]** sub: doble espacio → simple
- **[1328]** label: doble espacio → simple
- **[1329]** 1 espacio(s) espurio(s) tras salto de línea
- **[1340]** label: doble espacio → simple
- **[1341]** 1 espacio(s) espurio(s) tras salto de línea
- **[1377]** label: doble espacio → simple
- **[1378]** 1 espacio(s) espurio(s) tras salto de línea
- **[1525]** label: doble espacio → simple
- **[1526]** 1 espacio(s) espurio(s) tras salto de línea
- **[1617]** label: doble espacio → simple
- **[1618]** 1 espacio(s) espurio(s) tras salto de línea

## Marcadores sin rellenar (2)

- **[1]** extensión: «2026; páginas» → «2026; 268 páginas»
- **[32]** ficha de catalogación: «2026. páginas.» → «2026. 268 páginas.»

## Cuestiones que no se corrigieron
